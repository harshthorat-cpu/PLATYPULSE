...
$$R_{\text{data}} = \frac{(256 + \text{DRATE\_M}) \times 2^{\text{DRATE\_E}} \times f_{\text{XOSC}}}{2^{28}}$$

where:

-   $\text{DRATE\_M}$ = Data rate mantissa (MDMCFG3 register)
-   $\text{DRATE\_E}$ = Data rate exponent (MDMCFG4 register)
...
$$\text{BW}_{\text{channel}} = \frac{f_{\text{XOSC}}}{8 \times (4 + \text{CHANBW\_M}) \times 2^{\text{CHANBW\_E}}}$$

where:

-   $\text{CHANBW\_M}$ = Channel bandwidth mantissa
-   $\text{CHANBW\_E}$ = Channel bandwidth exponent
...
$$\Delta f = \frac{f_{\text{XOSC}}}{2^{17}} \times (8 + \text{DEVIATION\_M}) \times 2^{\text{DEVIATION\_E}}$$

where:

-   $\text{DEVIATION\_M}$ = Deviation mantissa
-   $\text{DEVIATION\_E}$ = Deviation exponent
